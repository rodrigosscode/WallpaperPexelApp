package br.com.sscode.wallpaperpexelapp.factory

import br.com.sscode.wallpaperpexelapp.framework.network.response.DataWrapperResponse
import br.com.sscode.wallpaperpexelapp.framework.network.response.Photo
import br.com.sscode.wallpaperpexelapp.framework.network.response.Src

class DataWrapperResponseFactory {

    fun create(nextPage: Int, page: Int, perPage: Int) = DataWrapperResponse(
